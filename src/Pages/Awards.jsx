...
const ImageGallery = () => {
  return (
    <div className="w-full mx-auto p-4 bg-[#E1F4FB]">
        <h1 className="font-[Belli] text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-6xl mt-5 p-5 text-black tracking-wide">Awards & Recognitions</h1>
