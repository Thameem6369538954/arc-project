...
const CookiePopup = () => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-10 font-[choco] bg-opacity-40 flex items-center justify-center z-40">
      <div className="bg-white p-6 rounded-lg shadow-lg text-center max-w-2xl animate-fade relative">
        {/* Close Button */}
        <button
        ...
        {showPreferences && (
          <div className="mt-4 text-left text-sm bg-gray-100 p-3 rounded">
            ...
            <label className="block">
              <input type="checkbox" className="mr-2" defaultChecked disabled /> Essential Cookies (Always On)
            </label>
            <button
